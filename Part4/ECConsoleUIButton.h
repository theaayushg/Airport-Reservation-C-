...
public:
    ...
    ECConsoleUIButton(int xUL, int yUL, int xLR, int yLR, const std::string &textButton, ECConsoleUIListBox *source, ECConsoleUIListBox *destination, ECConsoleUIListBox *flights, ECAirlineSimulator *sim);
...
private:
    ...
    ECConsoleUIListBox *source;
    ECConsoleUIListBox *destination;
